window.injectedEnv = {
    ...
    REACT_APP_REMOTE_CONTENT_ENABLED: '${REACT_APP_REMOTE_CONTENT_ENABLED}',
    REACT_APP_CONTENT_GITHUB_RAW_BASE: '${REACT_APP_CONTENT_GITHUB_RAW_BASE}',
    REACT_APP_CONTENT_GITHUB_OWNER: '${REACT_APP_CONTENT_GITHUB_OWNER}',
    REACT_APP_CONTENT_GITHUB_REPO: '${REACT_APP_CONTENT_GITHUB_REPO}',
    REACT_APP_CONTENT_GITHUB_REF: '${REACT_APP_CONTENT_GITHUB_REF}',
    REACT_APP_CONTENT_MANIFEST_PATH: '${REACT_APP_CONTENT_MANIFEST_PATH}',
    REACT_APP_CONTENT_POLL_MS: '${REACT_APP_CONTENT_POLL_MS}',
    REACT_APP_CONTENT_FALLBACK_ENABLED: '${REACT_APP_CONTENT_FALLBACK_ENABLED}'
};
